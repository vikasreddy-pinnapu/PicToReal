  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      ...
      {!aiResponse ? (
        ...
        //   </button>
        // </div>
        <div className="bg-[#2c2c2c] shadow-lg p-8 w-full max-w-md relative rounded-lg h-screen flex flex-col font-sans justify-around ">
        ...
        <div className="bg-[#2c2c2c] shadow-lg p-8 w-full max-w-md">
          <div>
            <OutputContainer heading={"Markup"} content={aiResponse.wmMarkup} />
          </div>
          <div className="mt-5">
